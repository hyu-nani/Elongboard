...
void ALL_WHITE_Grade(uint16_t wait);//bottom 점차 백색으로 켜짐
void B_ALL_WHITE_Grade(uint16_t wait);//bottom 점차 백색으로 켜짐
void T_ALL_WHITE_Grade(uint16_t wait);//top 점차 백색으로 켜짐

void ALL_Color(uint8_t red,uint8_t green,uint8_t blue);//all 색변환
void B_ALL_Color(uint8_t red,uint8_t green,uint8_t blue);//bottom 색변환
void T_ALL_Color(uint8_t red,uint8_t green,uint8_t blue);//top 색변환
...
void ALL_WHITE_Grade(uint8_t maximum, uint16_t wait) //bottom 점차 백색으로 켜짐
{	
	if(initialize_neo == 0){
	}
...
void B_WHITE_Grade(uint8_t maximum, uint16_t wait) //bottom 점차 백색으로 켜짐
{
	if(initialize_neo == 0){
	}
...
void T_WHITE_Grade(uint8_t maximum, uint16_t wait) //top 점차 백색으로 켜짐
{
	if(initialize_neo == 0){
	}
...
void ALL_Color(uint8_t red,uint8_t green,uint8_t blue,uint8_t white)  //all 색변환
{
	if(initialize_neo == 0){
		for(int i=0; i < 46 ; i++){
...
void B_Color(uint8_t red,uint8_t green,uint8_t blue,uint8_t white)  //bottom 색변환
{
	if(initialize_neo == 0){
		for(int i=0; i < 22 ; i++){
			strip.setPixelColor(i, strip.Color(red, green, blue, white));
...
void T_Color(uint8_t red,uint8_t green,uint8_t blue,uint8_t white)  //top 색변환
{
	if(initialize_neo == 0){
		for(int i=22; i < 46 ; i++){
			strip.setPixelColor(i, strip.Color(red, green, blue, white));
