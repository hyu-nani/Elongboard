...
void Send_RGBW(){
	...
	change_r = 1000 + change_r;
	change_g = 1000 + change_g;
	change_b = 1000 + change_b;
	change_w = 1000 + change_w;
	BT_Serial.print("C[R:");
	BT_Serial.print(change_r);
	BT_Serial.print("/G:");
	BT_Serial.print(change_g);
	BT_Serial.print("/B:");
	BT_Serial.print(change_b);
	BT_Serial.print("/W:");
	BT_Serial.print(change_w);
	BT_Serial.println("]");
	change_r = change_r - 1000;
	change_g = change_g - 1000;
	change_b = change_b - 1000;
	change_w = change_w - 1000;
}
